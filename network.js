...
const { create_keys_from_seed, get_new_peer_keys, parse, sleep, log } = require('./utils')
...
class Network extends EventEmitter {
  ...
  node_connection(conn, info) {
    log(chalk.green("New node connection"))
  ...
  async client_connection(conn, info) {
    log(chalk.green("Incoming client connection"))
