...
const MAX_NODE_INBOUND_BYTES = 120000
const MAX_CLIENT_INBOUND_BYTES = 120000
const MAX_SYNC_MESSAGES = 500
const MAX_JOB_BLOB_HEX_BYTES = 1024
const CLIENT_POST_COOLDOWN_MS = 1000
const CLIENT_JOB_REQUEST_MAX_PER_10S = 10
const CLIENT_POW_TAG_MAX_PER_10S = 5
const GLOBAL_JOB_REQUEST_MAX_PER_10S = 500
const GLOBAL_POW_TAG_MAX_PER_10S = 50
